...
from app.workflow.engine import WorkflowNodeExecutor
...
class AgentWorkflowExecutor(WorkflowNodeExecutor):
    """
    Executes workflow nodes through the
    standardized Agent execution boundary.
